...
export default function Home() {
  ...
  return (
    <>
      <header className="mx-4 sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 text-sm">
        <nav className=" flex mt-4 relative w-full bg-white border border-gray-200 rounded-[24px] mx-2 flex flex-wrap md:flex-nowrap items-center justify-between p-8 md:py-0 sm:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
      ...
      <div className='mx-4 p-8 flex flex-row'>
        <div className='w-[60%] flex items-center'>
          Hello!! 
        </div>
        <div className='w-[40%]'>
          <svg viewBox="0 0 795 596" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M398.921 591.338C397.822 591.393 400.111 591.281 398.921 591.338ZM398.921 591.338C368.149 592.792 304.658 594.746 285.345 591.338C260.27 586.913 217.494 481.449 293.457 438.674C354.228 404.454 454.97 395.899 497.745 395.899L637.134 415.074L398.921 591.338Z" stroke="black" stroke-width="2.91102" />
            ...
            <path d="M615.745 593.277C712.357 562.302 637.132 422.176 637.132 417.014L600.994 412.042C416.913 423.405 389.576 537.6 398.918 593.277L429.984 849.191H510.037L516.919 593.277H615.745Z" fill="white" stroke="black" stroke-width="2.91102" />
            ...
            <path d="M512.714 146.088C508.83 141.143 498.73 125.958 489.407 104.77C491.526 102.297 495.551 94.8104 494.704 84.6398C483.686 82.9447 477.009 59.2134 475.048 47.5596C489.679 39.4435 477.212 17.7929 481.991 16.8366C487.288 15.7766 501.061 21.0738 501.061 34.8464C501.061 48.619 524.657 42.118 530.725 39.0841C545.556 31.6681 540.26 49.6796 533.903 66.63C530.513 72.5628 542.378 83.9341 548.735 88.8781C550.429 105.829 535.315 131.962 527.546 142.909C528.606 174.692 528.818 238.258 521.19 238.258C516.105 228.088 513.421 172.573 512.714 146.088Z" fill="white" stroke="black" stroke-width="1.94068" />
            <path d="M503.177 49.6725C501.411 51.4383 498.939 56.4529 503.177 62.3858" stroke="#241715" stroke-width="0.970341" />
            <path d="M511.652 65.5718C510.946 69.4564 507.838 75.3186 501.058 67.6907" stroke="#241715" stroke-width="0.970341" />
            <path d="M534.96 52.8538C536.372 48.9692 538.138 41.4119 533.9 42.2594" stroke="#241715" stroke-width="0.970341" />
            <path d="M493.572 96.2916C494.506 93.0569 495.075 89.1066 494.702 84.6383C500.573 87.817 510.592 88.8765 531.781 74.0435C532.627 85.0616 506.661 93.4664 493.572 96.2916Z" fill="black" />
            <path d="M547.674 16.8356C555.09 34.846 538.139 59.213 533.901 66.629C540.258 49.6786 544.495 31.6671 530.723 39.0832C524.75 42.2994 501.059 48.6181 501.059 34.8454C501.059 21.0728 487.286 15.7756 481.989 16.8356C477.21 17.7919 489.677 39.4426 475.047 47.5587C473.46 48.4386 471.556 49.1594 469.276 49.6775C474.573 42.2615 472.454 43.3209 468.216 25.3105C463.979 7.30016 483.049 3.06296 501.059 0.944096C519.069 -1.17477 540.258 -1.17477 547.674 16.8356Z" fill="black" />
            <path d="M647.26 131.256C633.699 113.457 575.924 95.5883 548.732 88.8785C550.427 105.829 535.313 131.962 527.544 142.91C528.604 174.693 528.815 238.259 521.188 238.259C516.102 228.088 513.418 172.574 512.712 146.088C508.827 141.144 498.728 125.959 489.405 104.77C487.286 111.127 430.076 154.563 420.541 168.336C411.006 182.109 407.828 314.538 407.828 326.192C407.828 337.846 403.59 417.303 438.552 417.303C466.521 417.303 580.869 421.188 638.784 422.6C647.26 332.901 660.82 149.054 647.26 131.256Z" fill="black" />
            <path d="M407.831 326.185C465.747 314.178 581.578 300.971 581.578 344.196C581.578 387.42 527.9 411.849 501.061 418.659M581.578 98.3068C574.515 101.518 559.542 116.629 556.152 151.379C551.914 194.815 538.311 209.647 527.291 209.647M516.477 211.766C507.454 216.71 487.712 220.454 480.932 195.875C472.457 165.151 454.774 148.2 435.011 153.497M613.361 110.061C611.242 109.165 577.341 132.309 574.162 185.28C570.984 238.252 537.082 337.839 467.159 284.867C440.672 258.381 415.151 241.784 410.865 243.549M489.408 418.339C498.942 409.163 515.47 387.844 505.299 375.979C495.128 364.113 439.497 380.216 412.953 389.751M652.348 158.795C629.464 172.92 587.299 217.911 601.708 284.867C614.421 323.007 637.653 319.122 647.68 312.413M643.847 364.325C630.153 364.505 604.038 376.254 609.124 421.805" stroke="white" stroke-width="0.970341" />
            <path d="M521.188 417.293V239.308" stroke="#027269" stroke-width="0.970341" />
            ...
            <path d="M462.106 418.146L478.58 413.509" stroke="black" stroke-width="0.970341" />
            <path d="M449.596 407.801L478.476 404.295" stroke="black" stroke-width="0.970341" />
            <path d="M449.491 398.584L478.988 393.482" stroke="black" stroke-width="0.970341" />
            ...
            <path d="M638.285 125.499C585.382 112.759 586.075 307.754 609.043 352.24L501.015 363.222" stroke="white" stroke-width="0.970341" />
            ...
            <ellipse cx="11.5736" cy="13.3097" rx="11.5736" ry="13.3097" transform="matrix(-0.936312 0.351169 0.351169 0.936312 332.862 327.975)" fill="black" />
          </svg>
        </div>
