    ...
    <>
      ...
      < div id="contact_me" className='bg-neutral-100 p-8 scroll-mt-30' >
        ...
        <div className='flex flex-column text-neutral-800 items-center'>
          <div className='w-1/2 h-90 content-center m-8'>
          ...
          <div className='w-1/2 h-90 m-8 text-neutral-400 flex flex-col justify-center gap-5'>
            <div className='flex gap-5'>
              ...
              <a className='underline' href='mailto:advaitkhawase15@gmail.com'>
            ...
            <div className='flex gap-5'>
              ...
              <span className='underline' href='https://www.linkedin.com/in/advait-khawase/'>
            ...
            <div className='flex gap-5'>
              ...
              <span className='underline' href='https://github.com/advaitkhawase15'>
            ...
            <div className='flex gap-5'>
              ...
              <span className='underline' href='https://leetcode.com/u/advaitkhawase15/'>
            ...
            <div className='flex gap-5'>
              ...
              <span className='underline' href='https://www.geeksforgeeks.org/user/advaitkhawase/'>
